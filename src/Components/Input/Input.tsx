...
<div className="input_div">
    <form>
        <div className="title_pin">
            <input className="title_input" value={title} placeholder="Title" type="text"
                onChange={(e)=>setTitle(e.target.value)}/>
            <MdiLightPin />
        </div>
        <br />
        <div className="text_box">
            <textarea cols={50} className="text_area" placeholder="Take a note..." name="text" value={description}
